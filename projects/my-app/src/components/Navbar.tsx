      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex space-x-4">
            ...
            <Link href="/about" className="text-black hover:text-gray-300 px-3 py-2 rounded-md text-sm font-medium">
              About
            </Link>
            <Link href="/services" className="text-black hover:text-gray-300 px-3 py-2 rounded-md text-sm font-medium">
              Projects
            </Link>
